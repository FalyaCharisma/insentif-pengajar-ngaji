...
export function useAlamat() {
    ...
    // ================= KABKOTA =================
    const searchKabkota = async (kodeProvinsi: string, inputValue: string) => {
    ...
    // ================= KECAMATAN =================
    const searchKecamatan = async (kodeKabkota: string, inputValue: string) => {
    ...
    const searchKecamatanKotaKediri = async (inputValue: string) => {
        const res = await axios.get(
